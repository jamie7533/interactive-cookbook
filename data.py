...
spices = ['cumin', 'coriander', 'turmeric', 'garam masala', 'cardamom',
    ...
    'paprika', 'mustard powder', 'black pepper', 'oregano', 'cumin', 'caraway', 'red pepper', 'cayenne',
      'mirin', 'ginger', 'wasabi', 'sesame',
    'gochujang', 'garlic', 'ginger', 'sesame oil',
...
cuisine_spices = {
    ...
    'American': ['Salt', 'Pepper', 'Garlic Powder', 'Onion Powder', 'Paprika', 'Chili Powder', 'Cumin', 'Oregano', 'Thyme', 'Rosemary'],
    'Austrian': ['Caraway Seeds', 'Marjoram', 'Paprika', 'Juniper Berries', 'Fennel Seeds', 'Cumin'],
    'Bangladeshi': ['Cumin', 'Coriander', 'Turmeric', 'Cinnamon', 'Cardamom', 'Cloves', 'Bay Leaves', 'Ginger'],
    ...
    'Egyptian': ['Cumin', 'Coriander', 'Garlic', 'Onion', 'Paprika', 'Cinnamon', 'Cloves', 'Bay Leaves', 'Cardamom', 'Nutmeg'],
    ...
    'German': ['Caraway Seeds', 'Mustard Seeds', 'Juniper Berries', 'Allspice', 'Bay Leaves', 'Nutmeg', 'Pepper', 'Parsley', 'Chives'],
    ...
    'Irish': ['Thyme', 'Rosemary', 'Bay Leaves', 'Parsley', 'Sage', 'Allspice', 'Nutmeg', 'Black Pepper', 'Cloves'],
    ...
    'Japanese': ['mirin', 'ginger', 'wasabi', 'sesame'],
    'Korean': ['gochujang', 'garlic', 'ginger', 'sesame oil'],
    ...
    'Swiss': ['Juniper Berries', 'Nutmeg', 'Parsley', 'Chives', 'Bay Leaves', 'Thyme', 'Rosemary', 'Sage', 'Caraway Seeds'],
...
cuisine_meats = {
    'Afghan': ['lamb', 'beef', 'chicken', 'goat', 'quail', 'duck'],
    ...
    'Cambodian': ['pork', 'beef', 'chicken', 'duck', 'frog'],
    'Canadian': ['beef', 'pork', 'chicken', 'wild game', 'salmon'],
    ...
    'Filipino': ['Pork', 'Chicken', 'Beef', 'seafood', 'offal'],
    ...
    'Nigerian': ['beef', 'Chicken', 'Goat'],
    'Peruvian': ['Chicken', 'Beef', 'Pork'],
    'Portuguese': ['beef','pork', 'chicken', 'lamb'],
